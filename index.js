                        ...
                        else
                        {
                            _.each(data.Items,function(item){
                                    ...
                                    _.each(item.videos,function(video){
                                        ...
                                        videoObject.addVideoItem(video.name,video.id,video.description,video.preview_image_url_ssl,video.label); 
...
var getVideoObject = function(){
    ...
    var categoryList = [];
            ...
            this.addVideoItem = function(name,id,description,imageurl,label){
            ...
            _.each(label,function(categoryItem){
                   // console.log(categoryItem.name);                   
                   categoryList.push(categoryItem.name);

            });
            
            this.category.push(categoryList);
            this.lang.push('');
